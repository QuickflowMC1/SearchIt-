...
rm ~/SearchIt!/build/patches-new/patch-list
...
for patch in $ALLPATCHS_E; do
	...
	echo $PATCH_FILE >>~/SearchIt!/build/patches-new/patch-list

done

tac ~/SearchIt!/build/patches-new/patch-list >~/SearchIt!/build/patches-new/zz-patch-list.txt
rm ~/SearchIt!/build/patches-new/patch-list
