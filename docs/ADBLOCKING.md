# SearchIt! AdBlock engine

## Modified version of Adblock plus integrated in SearchIt!

SearchIt! uses a modified version of adblock plus.
...
In SearchIt! it is disabled by default.
